...
/**
 * 针对指定类别套餐列表的适配器
 * Created by CodingEnding on 2018/4/26.
 */
public class CategoryFilterRecyclerAdapter extends RecyclerView.Adapter<CategoryFilterRecyclerAdapter.ViewHolder>{
    private List<SimplePackageBean> dataList;
    private Context context;
    private LayoutInflater inflater;
    private OnAdapterItemClickListener itemClickListener;

    public CategoryFilterRecyclerAdapter(List<SimplePackageBean> dataList, Context context) {
